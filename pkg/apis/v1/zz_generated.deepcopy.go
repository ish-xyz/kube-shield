...
func (in *ClusterPolicySpec) DeepCopyInto(out *ClusterPolicySpec) {
	*out = *in
	if in.ApplyOn != nil {
		...
		*out = make([]*ResourceAddress, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(ResourceAddress)
				**out = **in
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResourceAddress) DeepCopyInto(out *ResourceAddress) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourceAddress.
func (in *ResourceAddress) DeepCopy() *ResourceAddress {
	if in == nil {
		return nil
	}
	out := new(ResourceAddress)
